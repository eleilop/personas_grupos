...
export interface ApiCarCar extends Schema.CollectionType {
  ...
  attributes: {
    plate: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiParkingParking extends Schema.CollectionType {
  ...
  attributes: {
    ...
    car: Attribute.Relation<'api::parking.parking', 'oneToOne', 'api::car.car'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPersonPerson extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    tlf: Attribute.String & Attribute.Required;
    car: Attribute.Relation<'api::person.person', 'manyToOne', 'api::car.car'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
